  ...
  return (
    <div className="min-h-screen bg-slate-50 px-4 py-10 text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      <div className="mx-auto w-full max-w-3xl">
        ...
        <div className="mt-8 grid gap-4 rounded-3xl border border-slate-200 bg-white/90 p-6 shadow-sm dark:border-slate-800 dark:bg-slate-900/40">
          <div className="text-base font-bold">So funktioniert’s</div>
          <div className="text-sm text-slate-700 dark:text-slate-200">
            Du hast einen persönlichen Kalender. Über eine eigene URL kannst du später direkt wieder in deinen Kalender einsteigen.
          </div>
          <div className="grid gap-2 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm dark:border-slate-700 dark:bg-slate-950/40">
              ...
              <div className="mt-1 text-slate-600 dark:text-slate-300">Kinder, Eltern, Farben, Einstellungen</div>
            </div>
            <div className="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm dark:border-slate-700 dark:bg-slate-950/40">
          ...
          <div className="text-xs text-slate-500 dark:text-slate-400">
            Hinweis: Die kalender-spezifischen URLs (/k/slug) sind der nächste Schritt und werden in Kürze vollständig angebunden.
          </div>
        </div>
      </div>
    </div>
